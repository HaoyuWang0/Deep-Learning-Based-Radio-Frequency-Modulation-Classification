...
def CNNLSTM2016_plot():
    ...
    acc_base_lstm = npzfile['acc_base_cnnlstm']
    val_acc_base_lstm = npzfile['val_acc_base_cnnlstm']
    loss_base_lstm = npzfile['loss_base_cnnlstm']
    val_loss_base_lstm = npzfile['val_loss_base_cnnlstm']
